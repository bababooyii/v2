...
# ============================================================
# 8K test - keep model at 1080p, just post-scale
# ============================================================
...
# ============================================================
# TEST at different output resolutions
# ============================================================
...
for target_res in output_resolutions:
    ...
    for vi, video in enumerate(test_videos[:5]):
        try:
            ...
            # Target at output res
            target = preprocess(frame, target_res).unsqueeze(0).cuda()
            
            with torch.no_grad():
                # VAE at 256p internal -> 1080p output
...
print("\n✅ Done! Bitrate is always 0.15 Mbps regardless of output resolution.")